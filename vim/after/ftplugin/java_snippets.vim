...
" while: A while loop
exec "Snippet while while (".st.et.") { // ".st.et."<CR><CR>".st.et."<CR><CR>}<CR>".st.et
...
" if If-block
exec "Snippet if if (".st.et.") { // ".st.et."<CR>".st.et."<CR>}<CR>".st.et
...
" class
exec "Snippet class /**<CR>".st.et."<CR><CR>@author ".st.et."<CR>@version ".st.et."<CR> ".st.et."<CR>/<CR>".st.et." class ".st.et." ".st.et." {<CR><CR>".st.et."<CR><CR>}<CR>".st.et
